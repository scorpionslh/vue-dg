    ...
    return {
        ...
        load: function (data) {
            return { resolver: function (onSuccess, _, onAlways) {
                    ...
                    var result = data.page !== null && data.pageSize !== null
...
/* harmony default export */ var PageList = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    render: function (h) {
        ...
        linkNodes.splice.apply(linkNodes, __spreadArrays([2, 0], pageLinks));
...
/* harmony default export */ var components_TimeDisplay = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    render: function (h) {
        ...
        }, __spreadArrays(layout.map(function (i) { return renderValue(i); }), [
...
/* harmony default export */ var ValueListFilter = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    render: function (h) {
        ...
        return h("div", { class: "dg-value-list" }, [
            ...
            h("select", {
                on: {
                    change: function (e) {
                        ...
                        emitValue(newValues);
                        setTimeout(function () { return e.target.selectedIndex = 0; });
                    }
                },
                domProps: {
                    selectedIndex: 0
            ...
            ], availableOptions.map(function (i) { return h("option", [i.value]); })))
        ]);
    },
    components: {
        Checkbox: Checkbox
...
/* harmony default export */ var TextFilter = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    render: function (h) {
        ...
        var filterOperator = (_a = (filter ? filter[0].operator : null)) !== null && _a !== void 0 ? _a : FilterOperator.Contains;
        var emitValue = function (value, operator) {
            return _this.$emit("input", [{ filters: [{ field: _this.fieldName, operator: operator, value: value }] }]);
        };
        var options = [
        ...
        return h("div", {}, [
            h("select", {
                ...
                domProps: {
                    selectedIndex: options.findIndex(function (i) { return i.operator === filterOperator; })
                }
            }, options.map(function (i) { return h("option", localize(i.key)); })),
            h("input", {
                domProps: {
                    value: filterValue,
                },
                ...
                on: {
                    input: function (e) { return emitValue(e.target.value, filterOperator); }
                }
            })
        ]);
    },
        ...
        return h("div", {
            ...
            h("a", {
                ...
                on: {
                    ...
                    mousedown: function (e) { return e.stopPropagation(); }
                }
            }, "▼"),
            this.opened ? h("div", {
...
/* harmony default export */ var components_DataGrid = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
            ...
            this.$nextTick(function () {
                ...
                var request = {
                    sorting: (function () {
                        ...
                        return __spreadArrays(groupingPart, sortingPart);
                    })(),
                    page: _this.pageable ? _this.vPage : null,
                    pageSize: _this.pageable ? _this.pageSize : null,
    ...
    render: function (h) {
        ...
        var dataRows = (function () {
            ...
            return grouping.length === 0
                ...
                : pageData
                    ...
                    .selectMany(function (i) { return __spreadArrays([renderGroupRow(i.key, grouping.map(function (j) { return j.field; }))], i.values.map(renderRow).flat()); })
                    .toList();
        })();
        var tbody = h("tbody", { class: "dg-body" }, dataRows);
        var dataTable = h("table", { class: "dg-table" }, [h("colgroup", {}, cols), thead, tbody]);
        var noDataPlaceholder = (function () {
            if (!_this.noDataTemplate)
                return null;
            if (typeof _this.noDataTemplate !== "string") {
                var result = _this.noDataTemplate(h);
                return typeof result === "string" ? _this.$slots[result] : result;
            }
            return _this.$slots[_this.noDataTemplate];
        })();
        ...
        return h("div", {
            ...
            this.pageable ? h("div", { class: "dg-footer" }, __spreadArrays([this.canReload ? reloadLink : null, pageList, pager], ((_a = this.$slots.footer) !== null && _a !== void 0 ? _a : []))) : null,
...
function buildUrl(version, url, request) {
    ...
    var sort = request.sorting.length > 0
        ? request.sorting.map(function (i) { return i.field + " " + mapDirection(i.direction); }).join(", ")
        : null;
    ...
    var vars = __spreadArrays([
        { name: "$filter", value: filters },
        { name: "$orderby", value: sort }
    ], customVars).filter(function (i) { return i.value !== null; }).map(function (i) { return i.name + "=" + i.value; }).join("&");
    ...
    var pageVars = [
        ...
        countParam
    ].filter(function (i) { return i.value !== null; }).map(function (i) { return i.name + "=" + i.value; }).join("&");
    return {
        dataUrl: dataUrl,
...
function KendoMvc_buildUrl(url, request) {
    ...
    var dataUrl = url + "?" + vars;
    var joinSymbol = vars ? "&" : "";
    var page = (request.page !== null ? request.page : 0) + 1;
    var pageSize = request.pageSize !== null ? request.pageSize : 1000;
    return {
        dataUrl: dataUrl,
...
// CONCATENATED MODULE: ./src/i18n/pt-BR.ts
var pt_BR_calendar = {
...
/* harmony default export */ var pt_BR = (pt_BR_lang);
...
/******/ })["default"];
//# sourceMappingURL=DataGrid.common.js.map